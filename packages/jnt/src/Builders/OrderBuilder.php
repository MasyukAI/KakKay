...
use MasyukAI\Jnt\Rules\DimensionInCentimeters;
use MasyukAI\Jnt\Rules\MalaysianPostalCode;
use MasyukAI\Jnt\Rules\MonetaryValue;
use MasyukAI\Jnt\Rules\PhoneNumber;
use MasyukAI\Jnt\Rules\WeightInGrams;
use MasyukAI\Jnt\Rules\WeightInKilograms;
