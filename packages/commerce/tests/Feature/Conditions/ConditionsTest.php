...
describe('Cart-Level Conditions', function () {
    ...
    it('applies conditions to cart subtotal', function () {
    ...
    it('applies multiple conditions in order', function () {
        Cart::add('item', 'Item', 100.00, 1);
    ...
    it('applies subtotal conditions before total conditions', function () {
        Cart::add('item', 'Item', 100.00, 1);
...
describe('Item-Level Conditions', function () {
    ...
    it('applies conditions to specific items', function () {
    ...
    it('item conditions do not affect other items', function () {
        Cart::add('item-1', 'Item 1', 100.00, 1);
    ...
    it('can clear all item conditions', function () {
        Cart::add('item', 'Item', 100.00, 1);
...
describe('Condition Calculations', function () {
    beforeEach(function () {
        Cart::clear();
    });
    ...
    it('calculates fixed amount discounts correctly', function () {
        Cart::add('item', 'Item', 100.00, 1);
    ...
    it('calculates percentage fees correctly', function () {
        Cart::add('item', 'Item', 100.00, 1);
    ...
    it('calculates fixed amount fees correctly', function () {
        Cart::add('item', 'Item', 100.00, 1);
...
describe('Condition Compatibility', function () {
    beforeEach(function () {
        Cart::clear();
    });

    it('handles missing features from legacy implementations', function () {
        Cart::add('item', 'Item', 100.00, 1);
    ...
    it('counts items using count() method', function () {
