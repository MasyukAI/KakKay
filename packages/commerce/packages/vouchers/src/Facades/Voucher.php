 ...
 * @method static void recordUsage(string $code, string $userIdentifier, \Akaunting\Money\Money $discountAmount, ?string $cartIdentifier = null, ?array $cartSnapshot = null, string $channel = \AIArmada\Vouchers\Models\VoucherUsage::CHANNEL_AUTOMATIC, ?array $metadata = null, ?\Illuminate\Database\Eloquent\Model $redeemedBy = null, ?string $notes = null)
