...
describe('FieldNameConverter', function () {
    it('converts order-level clean field names', function () {
        $input = [
            'orderId' => 'ORDER123',
    ...
    it('converts sender address clean field names', function () {
        $input = [
            'sender' => [
                'name' => 'John Doe',
                'state' => 'Selangor',
    ...
    it('converts receiver address clean field names', function () {
        $input = [
            'receiver' => [
                'name' => 'Jane Smith',
                'state' => 'Kuala Lumpur',
    ...
    it('converts item clean field names', function () {
        $input = [
            'items' => [
                [
                    'name' => 'Widget',
    ...
    it('converts packageInfo clean field names', function () {
        $input = [
            'packageInfo' => [
                'quantity' => 1,
                'weight' => 1.5,
    ...
    it('converts all clean field names in complete order', function () {
        $input = [
            'orderId' => 'ORDER123',
    ...
    it('preserves API field names when no clean names present', function () {
        $input = [
    ...
    it('handles mixed clean and API field names (clean takes precedence)', function () {
        $input = [
            'orderId' => 'CLEAN_ORDER',
