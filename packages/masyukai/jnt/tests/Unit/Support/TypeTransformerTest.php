...
describe('TypeTransformer - Generic Methods', function () {
    it('converts integers to integer strings', function () {
    ...
    it('converts floats to integer strings (truncates decimals)', function () {
    ...
    it('converts string integers to integer strings', function () {
        expect(TypeTransformer::toIntegerString('5'))->toBe('5');
        expect(TypeTransformer::toIntegerString('999'))->toBe('999');
        expect(TypeTransformer::toIntegerString('1'))->toBe('1');
    });

    it('converts integers to decimal strings with 2 decimals', function () {
    ...
    it('converts floats to decimal strings with 2 decimals', function () {
    ...
    it('converts strings to decimal strings with 2 decimals', function () {
        expect(TypeTransformer::toDecimalString('5'))->toBe('5.00');
        expect(TypeTransformer::toDecimalString('5.5'))->toBe('5.50');
        expect(TypeTransformer::toDecimalString('5.456'))->toBe('5.46');
    });
...
describe('TypeTransformer - Context-Aware Methods', function () {
    describe('forItemWeight (GRAMS → integer)', function () {
        it('converts integer grams to integer string', function () {
        ...
        it('converts float grams to integer string (truncates)', function () {
            expect(TypeTransformer::forItemWeight(500.7))->toBe('500');
            expect(TypeTransformer::forItemWeight(999.99))->toBe('999');
        });

        it('converts string grams to integer string', function () {
            expect(TypeTransformer::forItemWeight('500'))->toBe('500');
            expect(TypeTransformer::forItemWeight('1000'))->toBe('1000');
        });
    });

    describe('forPackageWeight (KILOGRAMS → 2 decimals)', function () {
        it('converts integer kg to 2-decimal string', function () {
        ...
        it('converts float kg to 2-decimal string', function () {
        ...
        it('converts string kg to 2-decimal string', function () {
            expect(TypeTransformer::forPackageWeight('5'))->toBe('5.00');
            expect(TypeTransformer::forPackageWeight('5.5'))->toBe('5.50');
            expect(TypeTransformer::forPackageWeight('5.456'))->toBe('5.46');
        });
    ...
    describe('forDimension (CENTIMETERS → 2 decimals)', function () {
        it('converts integer cm to 2-decimal string', function () {
        ...
        it('converts float cm to 2-decimal string', function () {
        ...
        it('converts string cm to 2-decimal string', function () {
            expect(TypeTransformer::forDimension('25'))->toBe('25.00');
            expect(TypeTransformer::forDimension('25.5'))->toBe('25.50');
            expect(TypeTransformer::forDimension('25.756'))->toBe('25.76');
        });
    ...
    describe('forMoney (MALAYSIAN RINGGIT → 2 decimals)', function () {
        it('converts integer myr to 2-decimal string', function () {
        ...
        it('converts float myr to 2-decimal string', function () {
        ...
        it('converts string myr to 2-decimal string', function () {
            expect(TypeTransformer::forMoney('150'))->toBe('150.00');
            expect(TypeTransformer::forMoney('19.9'))->toBe('19.90');
            expect(TypeTransformer::forMoney('150.456'))->toBe('150.46');
        });
...
describe('TypeTransformer - Boolean Methods', function () {
    it('converts boolean true to Y', function () {
        expect(TypeTransformer::toBooleanString(true))->toBe('Y');
    });

    it('converts boolean false to N', function () {
        expect(TypeTransformer::toBooleanString(false))->toBe('N');
    });

    it('converts string Y to Y (case insensitive)', function () {
        expect(TypeTransformer::toBooleanString('Y'))->toBe('Y');
        expect(TypeTransformer::toBooleanString('y'))->toBe('Y');
    });

    it('converts string N to N (case insensitive)', function () {
        expect(TypeTransformer::toBooleanString('N'))->toBe('N');
        expect(TypeTransformer::toBooleanString('n'))->toBe('N');
    });

    it('converts any non-Y string to N', function () {
        expect(TypeTransformer::toBooleanString('X'))->toBe('N');
        expect(TypeTransformer::toBooleanString(''))->toBe('N');
        expect(TypeTransformer::toBooleanString('false'))->toBe('N');
    });

    it('converts Y string to boolean true', function () {
        expect(TypeTransformer::fromBooleanString('Y'))->toBeTrue();
        expect(TypeTransformer::fromBooleanString('y'))->toBeTrue();
    });

    it('converts N string to boolean false', function () {
        expect(TypeTransformer::fromBooleanString('N'))->toBeFalse();
        expect(TypeTransformer::fromBooleanString('n'))->toBeFalse();
    });

    it('passes through boolean values', function () {
        expect(TypeTransformer::fromBooleanString(true))->toBeTrue();
        expect(TypeTransformer::fromBooleanString(false))->toBeFalse();
    });
});

describe('TypeTransformer - Real-World Scenarios', function () {
    it('handles item weight transformation correctly', function () {
    ...
    it('handles package weight transformation correctly', function () {
    ...
    it('handles dimension transformation correctly', function () {
    ...
    it('handles money transformation correctly', function () {
