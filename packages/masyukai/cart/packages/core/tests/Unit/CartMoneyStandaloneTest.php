...
it('demonstrates how money should be used with the cart package', function () {
    // Create Money objects for precise price handling
        ...
        $shippingCost = CartMoney::fromMajorUnits(9.95, 'USD');
    $taxRate = 8.25; // 8.25%
...
it('shows money arithmetic capabilities', function () {
    $price1 = CartMoney::fromMajorUnits(10.50, 'USD');
    $price2 = CartMoney::fromMajorUnits(5.25, 'USD');
...
it('demonstrates currency safety', function () {
    $usdPrice = CartMoney::fromMajorUnits(100.00, 'USD');
    $eurPrice = CartMoney::fromMajorUnits(85.00, 'EUR');
...
it('demonstrates precision advantages over floats', function () {
    ...
    // Money precision - always exact
        $money1 = CartMoney::fromMajorUnits(0.1, 'USD');
        $money2 = CartMoney::fromMajorUnits(0.2, 'USD');
...
it('shows complex calculation scenarios', function () {
    // E-commerce scenario: cart total with tax and shipping
        $item1 = CartMoney::fromMajorUnits(29.99, 'USD');
        $item2 = CartMoney::fromMajorUnits(19.50, 'USD');
...
it('demonstrates different currency formatting', function () {
    $usd = CartMoney::fromMajorUnits(1234.56, 'USD');
    $eur = CartMoney::fromMajorUnits(1234.56, 'EUR');
    $jpy = CartMoney::fromMinorUnits(123456, 'JPY', 0); // No decimals for JPY
