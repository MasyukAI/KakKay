...
describe('PriceFormatManager Coverage', function () {
    ...
    it('handles different transformer classes', function () {
        ...
        config(['cart.price_formatting.transformer' => IntegerPriceTransformer::class]);
    ...
    it('creates integer transformer with correct parameters', function () {
        // Set config for integer transformer
        config([
            'cart.price_formatting.transformer' => IntegerPriceTransformer::class,
