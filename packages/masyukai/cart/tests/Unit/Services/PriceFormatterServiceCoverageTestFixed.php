...
describe('PriceFormatterService Additional Coverage', function () {
    ...
    it('can set and use different transformers', function () {
        ...
        expect($service->format(19.99))->toBe('20'); // Integer transformer rounds
    });
    ...
    it('works with integer transformer correctly', function () {
        ...
        expect($service->format(19.99))->toBe('20');
        expect($service->normalize('20'))->toBe(20.0);
    });

    it('works with localized transformer correctly', function () {
        ...
        expect($service->format(1999.50))->toBe('1.999,50');
        expect($service->normalize('1.999,50'))->toBe(1999.50);
    });
