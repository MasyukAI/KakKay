...
use MasyukAI\Stock\Tests\Support\TestProduct;

test('model can add stock', function () {
...
test('model can remove stock', function () {
    $product = TestProduct::create(['name' => 'Test Product']);
...
test('model can get current stock', function () {
    $product = TestProduct::create(['name' => 'Test Product']);
...
test('model can check if has sufficient stock', function () {
    $product = TestProduct::create(['name' => 'Test Product']);
    $product->addStock(50);
...
test('model can check if stock is low', function () {
    $product = TestProduct::create(['name' => 'Test Product']);
    $product->addStock(5);
...
test('model can get stock history', function () {
    $product = TestProduct::create(['name' => 'Test Product']);
...
test('model stock transactions relationship works', function () {
    $product = TestProduct::create(['name' => 'Test Product']);
