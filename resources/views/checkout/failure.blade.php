...
<head>
    ...
    <title>Pembayaran Gagal - Kak Kay</title>
        ...
        <div class="max-w-md w-full bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 p-8 text-center">
            <div class="mb-6">
                ...
                <h1 class="text-2xl font-bold text-white mb-2" style="font-family: 'Caveat Brush', cursive;">
                    Pembayaran <span class="text-red-400">Gagal</span>
                </h1>
                <p class="text-gray-300">
                    Maaf, pembayaran anda tidak dapat diproses. Sila cuba lagi atau hubungi kami untuk bantuan.
                </p>
            </div>

            <div class="space-y-4">
                <div class="bg-white/5 rounded-lg p-4">
                    <p class="text-sm text-gray-400 mb-1">Sebab Kegagalan</p>
                    <p class="text-white">{{ request('error', 'Masalah teknikal dengan pembayaran') }}</p>
                </div>

                <div class="space-y-3">
                          <a href="{{ route('checkout') }}" wire:navigate.hover
                       class="block w-full bg-pink-500 hover:bg-pink-600 text-white font-medium py-3 px-4 rounded-lg transition-colors">
                        Cuba Bayar Lagi
                    </a>
                    
                          <a href="{{ route('cart') }}" wire:navigate.hover
