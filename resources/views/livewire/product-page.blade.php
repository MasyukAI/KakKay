                ...
                <div class="relative overflow-hidden rounded-[32px] border border-white/15 bg-white/10 p-6 backdrop-blur-xl shadow-[0_30px_80px_rgba(15,3,37,0.45)] transition-all duration-500 group-hover:-translate-y-1 group-hover:shadow-[0_40px_120px_rgba(236,72,153,0.35)]">
                  ...
                  <div class="relative mx-auto flex justify-center">
                    ...
                    @if($product->getFirstMediaUrl('cover'))
                      <img src="{{ $product->getFirstMediaUrl('cover') }}" alt="{{ $product->name }}" class="relative w-full max-w-xs rounded-[26px] object-cover shadow-[0_25px_60px_rgba(17,0,34,0.55)]">
                    @else
                      <img src="{{ asset('storage/images/cover/' . $product->slug . '.webp') }}" alt="{{ $product->name }}" class="relative w-full max-w-xs rounded-[26px] object-cover shadow-[0_25px_60px_rgba(17,0,34,0.55)]">
                    @endif
                  </div>
