<div class="checkout-container relative overflow-hidden min-h-screen bg-[#0f0218] text-white">
    <div class="pointer-events-none absolute inset-0 overflow-hidden">
        <div class="absolute -top-48 -left-40 h-[520px] w-[520px] rounded-full bg-gradient-to-br from-pink-500/35 via-purple-500/25 to-rose-500/40 blur-2xl"></div>
        <div class="absolute top-1/2 -right-32 h-[520px] w-[520px] -translate-y-1/2 rounded-full bg-gradient-to-br from-fuchsia-500/25 via-rose-500/25 to-orange-400/35 blur-2xl"></div>
